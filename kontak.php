			...
			<div id="leftcol">
				<div class="block">
					...
					<div class="block-content">
						<?php 	if($link==''){include('kontak/tulis.php');} else
						if($link=='tulis'){include('kontak/tulis.php');}else
						if($link=='kirimkan'){include('kontak/kirim.php');}else
						if($link=='lihat'){include('kontak/lihat.php');}else
						{include('kontak/tulis.php');}
						?>
					</div>
